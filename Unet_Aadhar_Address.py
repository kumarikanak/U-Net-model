...
# path1 = 's3://kanak-sagemaker/Semantic-Segmentation/Pan_Cards/'
# path2 = 's3://kanak-sagemaker/Semantic-Segmentation/Pan_Masks/'

# path1 = 's3://kanak-sagemaker/Semantic-Segmentation/Augmented_pan/'
# path2 = 's3://kanak-sagemaker/Semantic-Segmentation/Augmented_Pan_Mask/'

# path1 = 's3://kanak-sagemaker/Semantic-Segmentation/Pan_Cards_Data/'
# path2 = 's3://kanak-sagemaker/Semantic-Segmentation/Pan_Cards_Mask/'

# path1 = 's3://kanak-sagemaker/Semantic-Segmentation/Aadharf_Pan/'
# path2 = 's3://kanak-sagemaker/Semantic-Segmentation/Aadharf_Pan_Masks/'

path1 = 's3://kanak-sagemaker/Semantic-Segmentation/Aadhar_left_right_lang/'
...
imgs, X_valid, masks, y_valid = train_test_split(imgs, masks, test_size=0.2, random_state=123)
X_train, X_test, y_train, y_test = train_test_split(imgs, masks, test_size=0.2, random_state=256)
